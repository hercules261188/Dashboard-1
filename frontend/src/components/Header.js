				...
				<div className='mt-4 mr-6 flex items-center'>
					...
					<div>
						<input
							type='text'
							id='rounded-search'
							class='py-2 px-4 rounded-sm border-transparent bg-transparent text-gray-300 placeholder-gray-400 text-base focus:outline-none focus:ring-2 focus:ring-gray-700'
